import { db, getSetting, audit } from '../database/index.js';
...
async function latest(repo) {
  const r = await fetch(`https://api.github.com/repos/${repo}/releases/latest`, { headers: { 'Accept':'application/vnd.github+json','User-Agent':'Monero-Farm-Panel/1.1.0' }, signal: AbortSignal.timeout(8000) });
