...
async function renderOperations(){
  ...
  $('#view').innerHTML=`<div class="grid2"><div class="panel"><h2>${t('operations.selectServers')}</h2><p class="muted">${t('operations.rollingHint')}</p><div class="server-check-list">${checks}</div></div><div class="panel"><h2>Rolling restart</h2><p class="muted">${t('operations.restartHint')}</p><button id="rolling-restart" class="primary">${t('operations.startRestart')}</button></div></div>
